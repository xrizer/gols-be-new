...
<head>
  <meta charset="utf-8">
  <title>crypto-shuffle tests in your browser</title>
  <style>
    body {
...
<body>
   <p>
        Click a <em>description title</em> to run its specs only.<br/>
  ...
  <script src="https://unpkg.com/crypto-shuffle/dist/crypto-shuffle.spec.js"></script>
  <script>
    mocha.run();
  </script>
</body>
